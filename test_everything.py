import unittest
from Alpha1_str_to_arr import Tokenizer, str_to_arr
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_normal(self):
        s = 'ad b c d'
        self.assertEqual(str_to_arr(s), ['ad', 'b', 'c', 'd'])
    ...
    def test_spaces_only(self):
        s = '     ' #namely 5 spaces
        self.assertEqual(str_to_arr(s), [])

    def test_spaces_and_alpha(self):
        s = '     a' #5 spaces and alpha
        self.assertEqual(str_to_arr(s), ['a'])
    ...
    def test_no_spaces(self):
        s = 'abv'
        self.assertEqual(str_to_arr(s), ['abv'])
